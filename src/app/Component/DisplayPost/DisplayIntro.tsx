  ...
  return (
    <div className="my-8 relative flex justify-between">
        ...
        <div className="w-8/12">
            <p id={0} className={`${varId === 0 ? "" : "hidden"}`} >{variantes.variante1.intro}</p>
            <p id={0} className={`${varId === 1 ? "" : "hidden"}`}>{variantes.variante2.intro}</p>
            <p id={0} className={`${varId === 2 ? "" : "hidden"}`}>{variantes.variante3.intro}</p>
        </div>
